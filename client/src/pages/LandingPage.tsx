    ...
    <div className="min-h-screen bg-dark-950 text-dark-100 overflow-x-hidden">
      ...
      <footer className="border-t border-dark-800 px-6 py-8">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <p className="text-dark-500 text-sm">© 2024 FlowBoard. Built with ♥</p>
          <div className="flex items-center gap-4 text-dark-500">
            <a href="#" className="hover:text-dark-200 transition-colors"><Github size={18} /></a>
            <a href="#" className="hover:text-dark-200 transition-colors"><Twitter size={18} /></a>
          </div>
        </div>
      </footer>
    </div>
